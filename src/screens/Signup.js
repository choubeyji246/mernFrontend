...
const handleClick = async (e) => {
 ...
 console.log(lat, long)
  const response = await fetch("https://mernbackend-96yx.onrender.com/api/getlocation", {
    method: 'POST',
    headers: {
...
axios.post("https://mernbackend-96yx.onrender.com/api/createuser",credentials) 
.then(res => {
    ...
    <div style={{ backgroundImage: 'url("https://images.pexels.com/photos/1565982/pexels-photo-1565982.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")', backgroundSize: 'cover',height: '100vh' }}>
      ...
      <Navbar />
        ...
        <div className='container' >
          <form className='w-50 m-auto mt-3 bg-opacity-50 border bg-dark border-success rounded' onSubmit={handleSubmit}>
            <div className="m-3">
